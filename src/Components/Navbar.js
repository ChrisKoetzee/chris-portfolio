  ...
  return (
    <MDBNavbar expand='lg' className='navbar ' style={{ 
      ...
      color: '#7FFF00'
        ...
        <MDBCollapse navbar open={openBasic} className='d-flex justify-content-center flex-grow-1'>
          <MDBNavbarNav>
            <MDBNavbarItem>
              <MDBDropdown>
                <MDBDropdownToggle tag='a' className='nav-link' role='button' style={{ color: '#7FFF00'}}>
                  More about me
                </MDBDropdownToggle>
