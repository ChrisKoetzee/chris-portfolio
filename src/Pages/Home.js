...
const Home = () => {
    ...
    const handleScroll = () => {
        const imagePosition = document.getElementById('chris-img').getBoundingClientRect().top;
    ...
    return (
        <section id='home' className='home'>
            <Container fluid className="d-flex flex-column justify-content-center home" 
                style={{ 
                        height: '100vh',           
                        width:'100%',
                        marginTop: '10rem',
                ...
                <Row className="w-100" style={{ 
                    ...
                    <p style={{color : "yellow"}}>
                        <strong>"Motivated career changer with a creative flair and a hunger to learn"</strong>
                    </p>
                    </Col>
                    <Col  xs={12} sm={12} md={12} lg={12} xl={6} className="d-flex flex-column align-items-center justify-content-center">
                        <Image  
